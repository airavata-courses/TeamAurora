package com.sg.aurora.forecasttriggerworker.thrift.client;
...
import com.sg.aurora.forecasttriggerworker.client.aurora.*;
	...
	public static AuroraThriftClient getAuroraThriftClient(String auroraSchedulerPropFile) throws Exception {
		try {
			if(thriftClient == null) {
				...
				properties.load(AuroraClient.class.getClassLoader().getResourceAsStream(auroraSchedulerPropFile));
