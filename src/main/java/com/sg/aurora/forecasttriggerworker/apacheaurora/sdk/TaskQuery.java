            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                {
                  _elem154 = com.sg.aurora.forecasttriggerworker.apacheaurora.sdk.ScheduleStatus.findByValue(iprot.readI32());
      ...
      if (incoming.get(4)) {
        {
          ...
          {
            _elem179 = com.sg.aurora.forecasttriggerworker.apacheaurora.sdk.ScheduleStatus.findByValue(iprot.readI32());
