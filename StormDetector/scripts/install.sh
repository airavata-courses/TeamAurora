...
pip-3 install -r /home/ec2-user/python_libs/stormdetector/StormDetector/requirements.txt 
#usr/local/bin/pip-3.4 install virtualenv
#cd StormDetector
#virtualenv env
#source env/bin/activate
usr/local/bin/pip-3 install Flask
usr/local/bin/pip-3 install nose
usr/local/bin/pip-3 install BeautifulSoup4
usr/local/bin/pip-3 install bs4
usr/local/bin/pip-3 install Flask-SQLAlchemy
